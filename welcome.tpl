 ...
 <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="display:block">
      <div class="container">
	    ...
	    <span></span>
            ...
            <div class="form-group">
              <input type="text" placeholder="Email" required ng-model="user_credentials.email" class="form-control">
            </div>
            <div class="form-group">
              <input type="password" placeholder="Password" required ng-model="user_credentials.password" class="form-control">
            </div>
...
<div class="container-fluid"  style="display:block;margin-top:50px;background-image : url('~/../img/The_Way_To_GreenLog.jpg'); background-size: contain">
	...
	<div class="col-md-4">
        ...
        <div class="panel-body" >	
			<form name="sign_up_form" id="sign_up_form" action="_register"  methode="POST" onsubmit="return :match_password()" class="form-horizontal" novalidate role="form">
			...
			<div class="form-group">   
				<input type="text" placeholder="User name" required name="iname"  ng-model="user.iname" class="form-control input_text">
			</div>
			...
			<div class="form-group">
				<input type="text" placeholder="Password" required id="password" name="password" ng-model="user.password" class="form-control input_text"> 
			</div>

			<div class="form-group">
				<input type="text" placeholder="Re-type password" id="repassword" data-match="user.password" required name="repassword" ng-model="user.repassword" class="form-control input_text"> 
			</div>

			<div class="form-group" style="display:none">
				<input type="text"  id="rand" name="catpcha"   class="form-control"> 
			</div>
